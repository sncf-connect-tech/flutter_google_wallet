...
class GoogleWalletApi {
  ...
  Future<bool> getWalletApiAvailabilityStatus() async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.GoogleWalletApi.getWalletApiAvailabilityStatus', codec,
        binaryMessenger: _binaryMessenger);
    final List<Object?>? replyList =
        await channel.send(null) as List<Object?>?;
    if (replyList == null) {
  ...
  Future<void> savePasses(String arg_jsonPass, int arg_addToGoogleWalletRequestCode) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        ...
        binaryMessenger: _binaryMessenger);
    final List<Object?>? replyList =
        await channel.send(<Object?>[arg_jsonPass, arg_addToGoogleWalletRequestCode]) as List<Object?>?;
    if (replyList == null) {
      throw PlatformException(
        code: 'channel-error',
        message: 'Unable to establish connection on channel.',
