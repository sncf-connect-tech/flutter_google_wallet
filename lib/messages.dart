...
class GoogleWalletApi {
  ...
  Future<void> initWalletClient() async {
    const String __pigeon_channelName =
        'dev.flutter.pigeon.flutter_google_wallet.GoogleWalletApi.initWalletClient';
  ...
  Future<bool> getWalletApiAvailabilityStatus() async {
    const String __pigeon_channelName =
        'dev.flutter.pigeon.flutter_google_wallet.GoogleWalletApi.getWalletApiAvailabilityStatus';
    final BasicMessageChannel<Object?> __pigeon_channel =
        BasicMessageChannel<Object?>(
      __pigeon_channelName,
      pigeonChannelCodec,
  ...
  Future<void> savePasses(
    ...
    const String __pigeon_channelName =
        'dev.flutter.pigeon.flutter_google_wallet.GoogleWalletApi.savePasses';
    final BasicMessageChannel<Object?> __pigeon_channel =
        BasicMessageChannel<Object?>(
      __pigeon_channelName,
      pigeonChannelCodec,
  ...
  Future<void> savePassesJwt(
      String jsonPass, int addToGoogleWalletRequestCode) async {
    const String __pigeon_channelName =
        'dev.flutter.pigeon.flutter_google_wallet.GoogleWalletApi.savePassesJwt';
    final BasicMessageChannel<Object?> __pigeon_channel =
        BasicMessageChannel<Object?>(
      __pigeon_channelName,
      pigeonChannelCodec,
